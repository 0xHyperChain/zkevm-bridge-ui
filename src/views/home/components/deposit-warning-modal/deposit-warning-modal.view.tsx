...
import {
  DEPOSIT_CHECK_WORD,
  HYPERCHAIN_PRIVACY_POLICY_URL,
  HYPERCHAIN_TERMS_AND_CONDITIONS_URL,
  HYPERCHAIN_ZKEVM_RISK_DISCLOSURES_URL,
} from "src/constants";
      ...
      <div className={classes.background}>
        <Card className={classes.card}>
          ...
          <Typography className={classes.warningText} type="body1">
            You are about to transfer tokens using the HyperChain zkEVM Mainnet Beta. There are risks
            associated with your use of the Mainnet Beta here. You agree to the{" "}
            <ExternalLink href={HYPERCHAIN_TERMS_AND_CONDITIONS_URL}>Terms of Use</ExternalLink>,
            including{" "}
            <ExternalLink href={HYPERCHAIN_ZKEVM_RISK_DISCLOSURES_URL}>those risks</ExternalLink>, and
            the <ExternalLink href={HYPERCHAIN_PRIVACY_POLICY_URL}>Privacy Policy</ExternalLink>.
            <br />
            <br />
