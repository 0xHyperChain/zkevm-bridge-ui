...
import { ReactComponent as ZkEVMLogo } from "src/assets/zkevm.svg";
  ...
  return (
    <div className={classes.login}>
      <div className={classes.contentWrapper}>
        <svg className={classes.logo}><ZkEVMLogo /></svg>
        ...
        <ConfirmationModal
          message={
            <Typography type="body1">
              DISCLAIMER: This version of the HyperChain zkEVM will require frequent maintenance and
          ...
          title={`Welcome to the HyperChain zkEVM ${deploymentName || ""}`}
        />
      )}
    </div>
  );
