...
from Ethereum to the HyperChain zkEVM and back.
...
```sh
git clone git@github.com:0xHyperChain/zkevm-bridge-ui.git
```
...
-e HYPERCHAIN_ZK_EVM_RPC_URL=http://localhost:8123 \
-e HYPERCHAIN_ZK_EVM_EXPLORER_URL=http://localhost:4000 \
-e HYPERCHAIN_ZK_EVM_BRIDGE_CONTRACT_ADDRESS=0x9d98deabc42dd696deb9e40b4f1cab7ddbf55988 \
-e HYPERCHAIN_ZK_EVM_NETWORK_ID=1 \
