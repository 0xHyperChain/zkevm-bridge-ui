...
# HYPERCHAIN ZK EVM env vars
echo "VITE_HYPERCHAIN_ZK_EVM_RPC_URL=$HYPERCHAIN_ZK_EVM_RPC_URL" >> $ENV_FILENAME
echo "VITE_HYPERCHAIN_ZK_EVM_EXPLORER_URL=$HYPERCHAIN_ZK_EVM_EXPLORER_URL" >> $ENV_FILENAME
echo "VITE_HYPERCHAIN_ZK_EVM_BRIDGE_CONTRACT_ADDRESS=$HYPERCHAIN_ZK_EVM_BRIDGE_CONTRACT_ADDRESS" >> $ENV_FILENAME
echo "VITE_HYPERCHAIN_ZK_EVM_NETWORK_ID=$HYPERCHAIN_ZK_EVM_NETWORK_ID" >> $ENV_FILENAME
